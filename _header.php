...
<nav class="navbar navbar-inverse inner">
  <div class="container-fluid">
    <div class="navbar-header">
      <a class="navbar-brand" href="#">IFTC0509</a>
    </div>
    <div>
      <ul class="nav navbar-nav">
        ...
        <li><a href="tiposdedatos.php">Tipos de datos</a></li>
        <li><a href="#">Expresiones lógicas</a></li> 
        <li><a href="ls.php">Bucles</a></li>
        <li><a href="formulario.php">datos usuario</a></li>
